...
const Footer = () => {
    return(
        <footer className="footer mx-auto my-4 max-w-[90%] bg-white bg-opacity-20 bg-clip-padding backdrop-filter backdrop-blur-xl rounded-md items-center p-4 text-neutral-content static bottom-1">
